...
const EmployeeDashboard: React.FC = () => {
  ...
  const fetchTravelRequests = useCallback(async () => {
    ...
    const endpoint = `https://xpress-deployment.onrender.com/api/TravelRequest/ByUser/${user.userId}`;
    ...
    const fetchUserDocuments = async () => {
      ...
      try {
        ...
        const response = await axios.get(
          `https://xpress-deployment.onrender.com/api/Documents/User/${user.userId}`,
          {
            headers: {
  ...
  const handleEditClick = async (e: React.MouseEvent, request: TravelRequest) => {
    ...
    try {
      const endpoint = `https://xpress-deployment.onrender.com/api/TravelRequest/${request.id}`;
  ...
  const handleUpdateRequest = async (updatedData: any) => {
      ...
      const endpoint = `https://xpress-deployment.onrender.com/api/travelrequests/${humanReadableId}/edit`;
