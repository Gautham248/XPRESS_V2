...
describe('TravelInfoBanner Component', () => {
  ...
  test('correctly calls API with constructed URL', async () => {
    ...
    // Expected Results: axios.get called with 'https://xpress-backend-v3.onrender.com/api/TravelRequest/infobanner/SPECIFIC_ID'.
    ...
    await waitFor(() => { // Wait for the useEffect to run and call axios
      expect(mockedAxios.get).toHaveBeenCalledWith('https://xpress-backend-v3.onrender.com/api/TravelRequest/infobanner/SPECIFIC_ID');
    });
  });
