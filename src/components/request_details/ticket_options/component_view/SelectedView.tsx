...
const SelectedView: React.FC<Props> = ({
  ...
  return (
    <div className="card flex flex-col" style={{ height: '100%', minHeight: '400px' }}>
      ...
      {(buttons.length > 0 || customButtons.length > 0) && selectedOption && (
        <div className="sticky bottom-0 bg-white pt-4 border-t">
          <div className="flex justify-end gap-3">
            {buttons.includes('uploadTickets') && onUploadTickets && (
              <button
                className="flex items-center gap-2 px-6 py-3 bg-blue-600 text-white rounded-xl font-medium hover:bg-blue-700 shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all duration-200"
